...
import { usersFetchList, usersFetchFriendsList, usersUnfriendAuthor, usersBefriendAuthor, usersDeclineFriendRequest, usersFetchAuthorProfile, usersSyncRemoteFriends } from './users';
...
import { commentsAddComment, commentsGetComment} from './comments';
...
export function* sagas() {
    yield [
        ...
        fork(takeLatest, 'usersSyncRemoteFriends', usersSyncRemoteFriends),
        ...
        fork(takeLatest, 'commentsGetComment', commentsGetComment)
    ];
}
